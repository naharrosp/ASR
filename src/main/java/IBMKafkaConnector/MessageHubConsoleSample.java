...
public class MessageHubConsoleSample {
    ...
    private static final String APP_NAME = "PracticaFinalASR";
    private static final String DEFAULT_TOPIC_NAME = "No-Topic";
    ...
    public static void initMessageHubProperties (String bootstrapServers, String adminRestURL, String apiKey )  {
        try {
            ...
            //if (isRunningInBluemix) {
                ...
                resourceDir = "/home/vcap/app/WEB-INF/classes";
                System.out.println("\n\n"+resourceDir+"\n\n");

                //bootstrapServers = args[0];
                MessageHubConsoleSample.adminRestURL = adminRestURL;
                MessageHubConsoleSample.apiKey = apiKey;
...
//            }
    ...
    public static String getTopics(){
    	...
    	try {
           ...
           topics = RESTAdmin.listTopics(adminRestURL, apiKey);
          logger.log(Level.INFO, "Admin REST Listing Topics: " + topics);
      } catch (Exception e) {
          logger.log(Level.ERROR, "Error occurred accessing the Admin REST API " + e, e);
          //The application will carry on regardless of Admin REST errors, as the topic may already exist
