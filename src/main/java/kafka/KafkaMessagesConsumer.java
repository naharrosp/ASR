...
public class KafkaMessagesConsumer implements Runnable {
		  ...
		  private MessageHandler handler; //Este handler es un interfaz y el único link de vuelta para los mensajes.
		  private String topic; //Se guarda el topic para poder devolver esta información para el UserConnection

		  public KafkaMessagesConsumer(String topic, MessageHandler handler) {
